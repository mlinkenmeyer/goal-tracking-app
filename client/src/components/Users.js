    ...
    return (
        ...
        <div>
            ...
            <table>
                <tbody>
                    <tr>
                        <th style={{ textAlign: "left", width: "30%" }}>Name <FontAwesomeIcon icon={faSort} onClick={() => handleNameSort()} /></th>
                        <th style={{ textAlign: "left", width: "45%" }}>Email <FontAwesomeIcon icon={faSort} onClick={handleEmailSort} /></th>
                        <th>Edit</th>
                        <th>Delete</th>
                    </tr>
